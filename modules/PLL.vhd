...
-- Module  Version: 5.7
--C:\lscc\diamond\3.13\ispfpga\bin\nt64\scuba.exe -w -n PLL -lang vhdl -synth lse -arch xo3c00f -type pll -fin 8 -fclkop 400 -fclkop_tol 0.0 -trimp 0 -phasep 0 -trimp_r -phase_cntl STATIC -fb_mode 1 

-- Fri Jul 19 10:40:44 2024
...
architecture Structure of PLL is
    ...
    attribute FREQUENCY_PIN_CLKI of PLLInst_0 : label is "8.000000";
...
begin
    ...
    PLLInst_0: EHXPLLJ
        ...
        CLKOS_CPHASE=>  0, CLKOP_FPHASE=>  0, CLKOP_CPHASE=>  0, 
        ...
        CLKOS_DIV=>  1, CLKOP_DIV=>  1, CLKFB_DIV=>  50, CLKI_DIV=>  1, 
        FEEDBK_PATH=> "CLKOP")
